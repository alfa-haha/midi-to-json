...
window.zh = {
    ...
    "fileLimitInfoFree": "免费版限制：最多20个文件（总大小不超过100MB）",
    "fileLimitInfoPro": "Pro：更高的批量上限（适用软上限保护）",
    ...
    // Batch processing（补齐缺失 key，避免显示 undefined）
    "batchProcessing": "批量处理",
    "waitingToProcess": "等待中",
    "processing": "处理中...",
    "processingComplete": "处理完成",
    "retryBtn": "重试",
    "downloadFileBtn": "下载",
    "preparingZip": "正在准备ZIP文件...",
    "zipReady": "ZIP文件已准备好下载",

    // Limits + Pro (v0.1)
    "freeLimitExceeded": "免费版限制：最多20个文件 / 总大小100MB。升级 Pro 可解锁更高批量。",
    "upgradeToProBtn": "升级到 Pro",
    "proSoftLimitWarning": "检测到超大批量。为保证性能，建议分批处理。仍要继续吗？",
    "batchStarting": "开始转换…",
    "batchDoneSummary": "完成：成功 {success}，失败 {failed}。",
    "concurrentWorkersLabel": "并发数：",
    "workersRunningLabel": "运行中",
    "retryAllFailedBtn": "重试所有失败项",
    "retryAllStarted": "正在重试失败文件…",
    "downloadReportBtn": "下载 report.json",
    "clearResultsBtn": "清空结果",
    "proToolInfoActive": "✅ Pro 已解锁 — 并发：3，批量上限：已解锁（软上限保护），Report：已启用。",
    "proToolInfoInactive": "免费版 — 并发：1，限制：20 个文件 / 总大小 100MB。",
